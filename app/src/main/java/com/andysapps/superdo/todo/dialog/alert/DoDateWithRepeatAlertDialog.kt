...
class DoDateWithRepeatAlertDialog : DialogFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_alert_dodate_wtih_repeat, container, false)
    }
    ...
    private fun initUi() {
        ...
        deleteTask_b_possitive.setOnClickListener {
            EventBus.getDefault().post(ActionRemoveRepeatTask(true))
            dismiss()
        }
